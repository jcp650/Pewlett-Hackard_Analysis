...
CREATE TABLE retirement_emp as
...
-- Find info on salaries
SELECT * FROM salaries
ORDER BY to_date DESC

-- Create a general employee information table
SELECT emp_no,
    first_name,
last_name,
    gender
...
-- Create a query for the Sales Team
SELECT emp_no,
	first_name,
	last_name,
	dept_name
...
-- Create a query for the Sales and Development teams
SELECT emp_no,
	first_name,
	last_name,
	dept_name
